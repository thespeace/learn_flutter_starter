import 'package:http/http.dart' as http; //패키지의 함수명이 너무 일반적이라 namespace를 지정.

class WebtoonApiService {
  final String baseUrl = "https://webtoon-crawler.nomadcoders.workers.dev";
  final String today = "today";

  void getTodaysToons() async {//async(비동기 함수)에서만 await를 사용할 수 있고, 이는 요청을 완료하여 반환값을 받은 후에 다음 코드를 진행하라는 뜻.
    print("start");
